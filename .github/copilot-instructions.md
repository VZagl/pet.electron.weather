...
- Для стилей: 'Обновить CSS для мобильных устройств'
- Для настройки промптов Copilot: 'Настроить плагин Copilot: обновить prompt для коммитов'
- Для тестов: 'Добавить тесты для функции calculateSum'
- Для новых функций: 'Добавить функцию calculateSum'
